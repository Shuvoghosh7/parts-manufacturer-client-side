...
const ShowReview = ({ rev }) => {
    ...
    <div className="mx-16">
      <div className="card card-compact bg-[#EEEEEE] lg:w-[350px]  w-[300px] lg:h-96 shadow-xl flex py-10 items-center md:mx-5px  lg:mx-0">
        ...
        <div className="flex flex-col items-center justify-center gap-4  dark:text-black">
          ...
          <div className="flex lg:mt-5 md:mt-12 mt-12  text-xl">
            {rating >= 1 ? (
